...
#         as local as well.
#  Default: ['localhost']
c.NotebookApp.local_hostnames = ['localhost', '127.0.0.1', '0.0.0.0']
...
#  Choices: any of ['sha3_224', 'sha3_256', 'sha1', 'sha3_512', 'md5', 'sha512', 'sha256', 'sha3_384', 'blake2b', 'sha384', 'sha224', 'blake2s']
#  Default: 'sha256'
